  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-10 w-full rounded-md border border-input bg-input/80 px-3 py-2 text-base ring-offset-background backdrop-blur-sm", // Use bg-input with alpha, consistent blur
